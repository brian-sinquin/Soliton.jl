...
- Quantitative indicators: soliton number, dispersion/nonlinear lengths, B-integral self-focusing risk
...
For detailed information on the physical models, numerical methods, and API reference, please refer to the [documentation](https://brian-sinquin.github.io/Soliton.jl/).
