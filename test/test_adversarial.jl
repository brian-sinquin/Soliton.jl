...
# ─────────────────────────────────────────────────────────────────────────────
# Adversarial comparison tests: GNLSE vs gnlse-python (v2.0.0)
#
...
@testset "Adversarial: GNLSE vs gnlse-python" begin
    ...
    @testset "Scenario 1 — Fundamental soliton peak power" begin
        ...
        # GNLSE peak drift ≤ 0.5% over full propagation
    ...
    @testset "Scenario 3 — Linear dispersion broadening" begin
        ...
        # GNLSE matches analytical √2 broadening at z = L_D to within 2%
    ...
    @testset "Scenario 4 — Raman SSFS direction and magnitude" begin
        ...
        @test cent_julia[end] < cent_julia[1]   # GNLSE red-shifts
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # Scenario 5 — Full field output: compare GNLSE and gnlse-python output
